...
public class Constants {
    public final static String FILE_UPLOAD_DIC = "/shopping/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
//    public final static String FILE_UPLOAD_DIC = "D:\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int INDEX_GOODS_HOT_NUMBER = 50;//首页热卖商品数量
    public final static int INDEX_GOODS_NEW_NUMBER = 50;//首页新品数量
    public final static int INDEX_GOODS_RECOMMOND_NUMBER = 50;//首页推荐商品数量

    public final static int SHOPPING_CART_ITEM_TOTAL_NUMBER = 50;//购物车中商品的最大数量(可根据自身需求修改)

    public final static int SHOPPING_CART_ITEM_LIMIT_NUMBER = 50;//购物车中单个商品的最大购买数量(可根据自身需求修改)
    ...
    public final static int GOODS_SEARCH_PAGE_LIMIT = 9;//搜索分页的默认条数(每页10条)
